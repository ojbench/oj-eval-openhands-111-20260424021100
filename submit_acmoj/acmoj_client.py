...
def main():
    ...
    submit_parser.add_argument("--code-file", type=str, help="Direct code file submission")
    ...
    if args.command == "submit":
        if args.git_url:
            ...
            with open(args.code_file, 'r') as f:
                code_content = f.read()
            result = client.submit_code(args.problem_id, code_content)
        else:
            print("Error: Either --git-url or --code-file must be provided for submit command")
            exit(1)
